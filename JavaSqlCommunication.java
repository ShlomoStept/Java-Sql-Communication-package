...
*/
    ...
    public static void main(String[] args) throws Exception {
        JavaSqlCommunication jsc = new JavaSqlCommunication("jdbc:mysql://127.0.0.1:3306", "root", "DailyArqlearn1ng3!0", "ARQ");
        ...
        jsc.createTable("test1");
        jsc.createTextColumn( "tex", "test1");
        jsc.createIntColumn("ints" ,"test1");
        jsc.createBooleanColumn("boolea","test1" );
        jsc.createFloatColumn("floa","test1" );
        jsc.createRealColumn("rea","test1" );
        jsc.createImageColumn("imag","test1" );
        jsc.createDateColumn("dat","test1" );
        jsc.createDateTimeColumn("datetim","test1" );
        jsc.createBlobColumn("blo","test1" );
        jsc.createJSONColumn("jso","test1" );*/

        //test 3 : inserts

        /*jsc.insertInt("0","ints" ,"test1");
        jsc.insertText( "Temp","tex", "test1");
        jsc.insertBoolean(false,"boolea","test1" );
        jsc.insertFloat("00.00","floa","test1" );
        jsc.insertReal("00.00","rea","test1" );
        jsc.insertImage("Temp","imag","test1" );
        jsc.insertDate("2020-10-12","dat","test1" );
        jsc.insertDateTime("2020-10-12 01:12:12","datetim","test1" );
        jsc.insertBlob("Temp","blo","test1" );
